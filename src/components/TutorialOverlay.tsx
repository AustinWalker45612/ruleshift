      ...
      <>
        ...
        <ul style={{ fontSize: 13, paddingLeft: 18, marginBottom: 8 }}>
          <li style={{ marginBottom: 4 }}>
            Start with a{" "}
            <strong>spread-out guess that touches both letters and digits</strong>{" "}
        ...
        >
          ...
          <p style={{ marginBottom: 4 }}>
            A guess like <code>AA12</code> will always be{" "}
            <strong>INVALID</strong> (repeated A).
          </p>
          <p>
            Use this kind of logic when you play: try guesses that could be
            valid under every visible rule, and use INVALID results to quickly
            cross off big chunks of code space.
          </p>
        </div>
      </>
    );
